...
function updateTips(){
    ...
    function callback(tabs) {
        ...
        if(!inTiktok && !document.querySelector('#title p')){
            ...
            p.innerHTML = `Please visit <a target="_blank" href="https://www.tiktok.com/trending?lang=en">tiktok.com</a> to download your favorite video!`
...
function renderNone(){
    showList.innerHTML = 'Oooops, no video found...'
}
